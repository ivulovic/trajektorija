...
<div class="container">
	...
	<div>
		<h2 class="title">Мало смо залутали?</h2>
		<p class="description">
			Изгледа да линк до ове странице не постоји. Могуће да је садржај
			премештен, а могуће и да је линк неисправан. Било како било, пружам ти
			прилику да се вратиш на почетак.
		</p>
		<a class="link" href="/">Почнимо испочетка</a>
	</div>
</div>
